    ...
    <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-[#842E12] text-white p-6 md:p-8 lg:p-12 flex flex-col justify-center items-center text-center">
          <h3 className='text-[32px] md:text-[52px] lg:text-[48px] font-["Cormorant_SC"] mb-2'>
            Every Sunrise Is A Stand
          </h3>
          <h4 className='text-[24px] md:text-[32px] lg:text-[32px] font-["Cormorant_SC"] mb-4 md:mb-6'>
            Join The Rebellion.
          </h4>
