  ...
  return (
    <div className="relative w-full min-h-[800px] mt-16">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-16">
        <div className="max-w-4xl mx-auto bg-white/90 p-8 sm:p-12 rounded-lg">
          <h2 className="text-[62px] font-normal sm:text-[62px] font-['Cormorant_SC'] text-center">
            Jimmy&apos;s Story
          </h2>
          <h3 className="text-[20px] font-light sm:text-[20px] text-center text-gray-600 mb-12">
          ...
          <div className="space-y-6 text-gray-800">
            ...
            <blockquote className="border-l-4 border-[#EE9254] pl-6 italic mt-8 text-base font-bold">
              ...
              Believes In You.&quot;
              <footer className="mt-2 text-gray-600">— Jimmy, Founder</footer>
            </blockquote>
          </div>
        </div>
      </div>
