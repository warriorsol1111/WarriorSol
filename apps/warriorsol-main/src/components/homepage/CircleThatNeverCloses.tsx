  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 lg:py-16">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-6 sm:gap-8 mb-8 lg:mb-12">
        <div>
          <h2 className="text-[32px] sm:text-[42px] lg:text-[62px] leading-tight sm:leading-[1.1] lg:leading-[62px] font-['Cormorant_SC'] font-normal text-[#1F1F1F] capitalize">
            A Circle That Never Closes
          </h2>
          <p className="text-[16px] sm:text-[18px] lg:text-[20px] font-light font-['Inter'] text-[#1F1F1F]/70 capitalize mt-2 sm:mt-3">
