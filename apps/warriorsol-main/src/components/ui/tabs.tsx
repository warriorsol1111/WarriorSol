...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex !rounded-lg items-center justify-center cursor-pointer whitespace-nowrap px-6 py-2  h-10 md:h-14 !text-sm md:!text-[18px] font-medium border-2 border-[#1F1F1F4D] box-border", // force fixed height
