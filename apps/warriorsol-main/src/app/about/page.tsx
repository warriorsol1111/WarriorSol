    ...
    <main className="bg-white text-black font-inter">
      ...
      <section className="w-full px-6 md:px-24 py-20 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1 text-left">
          ...
          <p className="text-[16px] md:text-[18px] font-light text-black/80 leading-relaxed mt-4">
            We&apos;re here to:
          </p>
          <ul className="list-disc list-inside mt-3 text-[16px] md:text-[18px] font-light text-black/80 leading-relaxed">
            <li>
