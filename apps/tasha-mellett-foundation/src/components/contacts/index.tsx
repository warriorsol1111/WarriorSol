...
const Contacts = () => {
  ...
  return (
    <section className="w-full bg-white">
      {/* Heading Section */}
      <div className="py-8 sm:py-12 lg:py-16 px-6 sm:px-12 lg:px-24">
      ...
      {/* Form + Image Section */}
      <div className="flex flex-col lg:flex-row-reverse items-stretch w-full bg-white px-6 sm:px-12 lg:px-24 py-8 sm:py-12 gap-8">
        {/* Image */}
          ...
          >
            ...
            <div>
              ...
              <Textarea
                ...
                className={clsx(
                  "w-full h-[200px] sm:h-[250px] md:h-[300px] px-4 py-2 rounded-md border text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-300 resize-none overflow-y-auto",
                  errors.message
                    ? "border-red-500 focus:ring-red-300"
                    : "border-gray-300"
                )}
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-md text-[#023729] bg-[#C1E965] hover:bg-[#b3e06d] font-medium flex items-center justify-center gap-2"
            >
              {loading ? (
