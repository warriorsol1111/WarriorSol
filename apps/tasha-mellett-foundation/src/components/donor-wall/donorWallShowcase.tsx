      ...
      <section className="w-full flex flex-col lg:flex-row gap-8 bg-white py-8 px-4 sm:px-6 rounded-lg shadow-md mt-8">
        ...
        <div className="relative w-full lg:w-1/2 rounded-4xl overflow-hidden">
          <Image
            ...
            priority
          />
          <Card className="absolute bottom-4 left-4 right-4 bg-[#C1E965] p-6 rounded-lg shadow-md">
            ...
            >
              <Progress.Indicator
                className="bg-[#023729] w-full h-full transition-transform duration-500"
                style={{
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          <h2 className="text-2xl sm:text-[42px] font-extrabold mb-4">
            Top Contributors
          </h2>
              ...
              <div className="flex flex-col gap-4">
                {topIndividualDonations.map((donation) => {
                  ...
                  return (
                    <div
                      key={donation.id}
                      className="flex items-center justify-between bg-[#FAFAFA] rounded-lg p-4 sm:p-6 shadow-sm border-l-4 border-[#C1E965]"
                    >
          ...
          <div className="flex flex-col gap-4">
            {recentDonations.map((donation, idx) => {
              ...
              return (
                <div
                  key={donation.id || idx}
                  className="flex flex-col sm:flex-row sm:items-center justify-between bg-white rounded-xl px-4 sm:px-6 py-4 sm:py-5 shadow-sm border border-[#C1E965]"
                >
