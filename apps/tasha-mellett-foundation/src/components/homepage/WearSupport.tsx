...
const WearYourSupportSection = () => {
  ...
  const mainAppUrl = process.env.NEXT_PUBLIC_WARRIOR_SOL_MAIN_APP_URL!;
    ...
    <section className="relative w-full h-[70vh] sm:h-[80vh] lg:h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start min-h-full py-10 sm:py-16">
          {/* Left Content */}
          <div className="space-y-4 sm:space-y-6 text-white pt-8 sm:pt-16 lg:pt-24 md:ml-20">
            ...
            <p className="text-base sm:text-lg md:text-[24px] font-medium leading-relaxed text-white/90 max-w-xs text-left justify-left drop-shadow-md">
        ...
        <div className="absolute inset-0 flex items-end sm:items-center justify-center pb-10 sm:pb-0">
          <Button
            size="default"
            className="inline-flex items-center space-x-2 border border-white bg-transparent hover:bg-white/20 text-white text-sm sm:text-lg font-medium !px-6 sm:!px-10 lg:!px-10 py-2.5 sm:py-3 rounded-xl transition-all duration-300 group"
            onClick={() => router.push(mainAppUrl)}
          >
            Shop and Support{" "}
