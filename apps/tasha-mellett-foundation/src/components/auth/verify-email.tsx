        ...
        {step === 1 ? (
          <form onSubmit={handleSubmit} className="mt-12 w-full space-y-6">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="h-12 w-full bg-[#C1E965]  hover:bg-[#C1E965] text-lg text-black flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-12 w-full text-center space-y-6">
            ...
            <Button
              ...
              className="h-12 w-full hover:bg-[#C1E965] bg-[#C1E965] text-white  text-xl"
            >
              Back to Login
            </Button>
          </div>
